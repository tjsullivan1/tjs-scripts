...
output "web_app_prod_slot_names" {
  description = "Names of the prod deployment slots (if created)"
  value       = var.create_prod_slot ? azurerm_linux_web_app_slot.prod[*].name : []
}

output "web_app_prod_slot_urls" {
  description = "URLs of the prod deployment slots (if created)"
  value       = var.create_prod_slot ? azurerm_linux_web_app_slot.prod[*].default_hostname : []
}

output "web_app_prod_slot_ids" {
  description = "Resource IDs of the prod deployment slots (if created)"
  value       = var.create_prod_slot ? azurerm_linux_web_app_slot.prod[*].id : []
}
